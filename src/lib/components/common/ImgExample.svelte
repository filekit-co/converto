    ...
    <div class="relative group">
      <div class=" py-4 md:py-8">
        {#if buttonState === 'human'}
          ...
          >
            <img src="images/human-origin.jpg" />

            <img src="images/human-result.png" />
          </div>
        {/if}
        {#if buttonState === 'stuff'}
          ...
          >
            <img src="images/stuff-origin.jpg" />

            <img src="images/stuff-result.png" />
          </div>
        {/if}
        {#if buttonState === 'animal'}
          <div
            class="mx-auto w-full px-8 max-w-7xl overflow-x-scroll md:overflow-auto px-8 scroll-pl-8 md:scroll-p-0 flex flex-nowrap gap-6 md:grid md:grid-cols-2"
          >
            <img src="images/animal-origin.jpg" />

            <img src="images/animal-result.png" />
          </div>
        {/if}
        {#if buttonState === 'character'}
          <div
            class="mx-auto w-full px-8 max-w-7xl overflow-x-scroll md:overflow-auto px-8 scroll-pl-8 md:scroll-p-0 flex flex-nowrap gap-6 md:grid md:grid-cols-2"
          >
            <img src="images/character-origin.jpg" />

            <img src="images/character-result.png" />
          </div>
        {/if}
      </div>
    </div>
