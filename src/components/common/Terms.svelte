<div class="mx-8 my-6 justify-center">
  <div class=" my-6">
    ...
    <p>
      The current Terms and Conditions stipulate the legally binding conditions
    ...
    <p>
      ...
      affect third- parties. The User will be responsible before filekit of any
      penalty, sanction, and/or fine which the courts or other competent
      authorities could issue against filekit for noncompliance with any part of
      this Agreement.
    </p>
    <p>
    ...
    <div class="sideinfo">
      <p>
        You use filekit at your own risk. We provide no warranty regarding the
        Service.
      </p>
    </div>
